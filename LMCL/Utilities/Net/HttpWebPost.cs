...
namespace Magentaize.Net.LMCL.Utilities.Net
{
    public class HttpWebPost//懒得改名字了
    {
        ...
        /// <returns></returns>
        public static async Task<JObject> PostJsonToUriAsync(string uri, Dictionary<string, string> paramters)
        {

            var jsonObj = new JObject();
            foreach (var param in paramters)
            {
                jsonObj.Add(param.Key, JsValue.CreateStringValue(param.Value));
            }
            return await PostDataToUriAsync(uri, jsonObj.ToString());
        }
        public static async Task<JObject> PostDataToUriAsync(string uri, string paramters)
        {
        ...
        /// <returns></returns>
        public static async Task<JObject> GetJsonFromUriAsync(string uri, Dictionary<string, string> paramters)
        {
